...
const Footer = () => {
  ...
  return (
    <div
      className="pt-20 bg-base-200"
      style={{ clipPath: `ellipse(130% 100% at 51.45% 100%)` }}
    >
      <footer className="footer px-10 py-10 bg-base-200 text-base-content container mx-auto">
        <div>
          <svg
            width="50"
            height="50"
      ...
      <div className="text-center py-6">
        <p className="text-md font-semibold lg:text-md">
          Copyright &copy; 2022 - All rights reserved by {appName}.
        </p>
      </div>
    </div>
  );
